...
!(function (a, b) {
  ...
  if (!i && !j) {
    const p = (a.navigator.appVersion.match(/android/gi), a.navigator.appVersion.match(/iphone/gi));
  ...
  }, !1), a.addEventListener('pageshow', (a) => {
    a.persisted && (clearTimeout(d), d = setTimeout(c, 300));
  }, !1), e.readyState === 'complete' ? e.body.style.fontSize = `${12 * i}px` : e.addEventListener('DOMContentLoaded', () => {
